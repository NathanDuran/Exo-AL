...
public class FeatureExtraction {
    ...
    private static String resourceDirectory = "FeatureExtraction/src/resources";
    ...
    private static void writeToFile(String setName, int numAttributes, ArrayList<String> hostResults, ArrayList<String> nonHostResults) {
        ...
        try {
            PrintWriter out = new PrintWriter(new FileWriter(resourceDirectory + "/" + setName + "Set.arff", true));
